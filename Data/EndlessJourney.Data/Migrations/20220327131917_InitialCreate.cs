    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomBenefits", x => new { x.RoomId, x.BenefitId });
                    table.ForeignKey(
                        name: "FK_RoomBenefits_Benefits_BenefitId",
                        column: x => x.BenefitId,
                        principalTable: "Benefits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RoomBenefits_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomBenefits_BenefitId",
                table: "RoomBenefits",
                column: "BenefitId");

            migrationBuilder.CreateIndex(
                name: "IX_RoomBenefits_IsDeleted",
                table: "RoomBenefits",
                column: "IsDeleted");
